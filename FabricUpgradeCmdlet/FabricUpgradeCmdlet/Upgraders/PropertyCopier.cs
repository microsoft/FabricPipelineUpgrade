...
namespace FabricUpgradeCmdlet.Upgraders
{
    ...
    public class PropertyCopier
    {
            ...
            JToken value)
        {
            ...
            JObject target = this.fabricResourceObject;
            ...
            bool allowNull = true)
        {
            ...
            {
                this.alerts.AddPermanentError($"{this.resourcePath}/{from} must not be null.");
             ...
             JToken token)
        {
            ...
            if (token.Type == JTokenType.Object)
            {
                ...
                {
                    valid &= this.ValidateAdfToken(path + "." + subToken.Key, subToken.Value);
                }
            ...
            else if (token.Type == JTokenType.Array)
            {
                ...
                {
                    valid &= this.ValidateAdfToken(path + $"[{n}]", valueArray[n]);
                }
                return valid;
            }
